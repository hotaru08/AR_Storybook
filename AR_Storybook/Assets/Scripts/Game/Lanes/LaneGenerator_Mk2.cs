namespace ARStorybook.LaneItems
{
	...
	public class LaneGenerator_Mk2 : MonoBehaviour
	{
		...
		private void SpawnPlayer()
		{
            ...
            player.transform.position = new Vector3(spawnedLanes[playerStartLane].playerPosition.position.x, spawnedLanes[playerStartLane].playerPosition.position.y, spawnedLanes[playerStartLane].playerPosition.position.z);
