Shader "Custom/UI Shader/Fader with Transition and Transparency"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert(appdata v)
			{
				v2f o;
				o.vertex = UnityObjectToClipPos(v.vertex);
				o.grabVertex = ComputeGrabScreenPos(o.vertex);

				o.grabVertex.z = 1 - o.grabVertex.z;
				o.grabVertex.y = 1 - o.grabVertex.y;
